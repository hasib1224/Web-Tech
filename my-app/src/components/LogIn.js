    ...
    <form action="">
        <div className='contaner bg-success-subtle'>
            ...
            <div className='box shadow p-3 mb-5 bg-info rounded'>
                ...
                <center>
                    <a href="/recovery_password" style={{color:"blue"}}>Forgot Password?</a> <br /><br />
                    <input className='btn btn-outline-light' type="submit" value="Login" onClick={login_btn_clicked2}/>
                </center>
            </div>
